    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-10 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 md:mb-10">
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-3">
            <span className="bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full flex items-center gap-1.5 shadow-lg shadow-blue-500/20">
            ...
            <div className="flex items-center gap-1.5 font-bold text-slate-700 bg-slate-50 px-3 py-1 rounded-xl border border-slate-100">
              <ICONS.Star /> {bus.rating} / 5
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 md:gap-16">
        ...
        <div className="order-1 lg:order-2">
          <div className="sticky top-24 bg-white p-8 rounded-[2.5rem] border shadow-2xl shadow-slate-200/50">
            <div className="flex items-end justify-between mb-10">
              <div>
                <p className="text-4xl font-black text-slate-900 leading-none mb-1">₹{bus.pricePerDay.toLocaleString()}</p>
                <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest">Base fare per day</p>
              </div>
            ...
            <p className="text-center text-[10px] text-slate-400 mt-6 font-bold uppercase tracking-widest">
              Lock inventory with only 20% advance
            </p>
            ...
            <div className="space-y-3">
              ...
              <p className="text-[10px] text-slate-400 font-medium italic text-center">
                Includes boutique facilities, fuel, and specialized driver.
              </p>
            </div>
          </div>
        </div>
